...
// AJAX обработчик для комментариев и лайков
...
if ($action === 'delete') {
    ...
    // Проверяем права (модератор или админ или автор)
